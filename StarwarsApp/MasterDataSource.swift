...
struct MasterDataSource<T: Decodable & Hashable> {
    let networkController = NetworkController()
    func search(queryType: T.Type, filter: String, page: Int) throws {
        try networkController.search(queryType: queryType, filter: filter, page: page)
    }
