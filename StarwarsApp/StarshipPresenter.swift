...
struct StarshipPresenter: Decodable, CustomStringConvertible, AttributedConvertable {
    let model: Starship
    ...
    var attributed: NSAttributedString {
        ...
        result.append(NSAttributedString(string: model.MGLT))
        result.append(NSAttributedString(string: "\n"))
        ...
        result.append(NSAttributedString(string: model.consumables))
        result.append(NSAttributedString(string: "\n"))
